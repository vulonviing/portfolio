...
This repository is maintained as a non-commercial personal project for research, learning, and product experimentation.
...
![Mini Finance Dashboard home](https://raw.githubusercontent.com/vulonviing/mini-finance-dashboard/main/screenshots/mini-finance-dashboard-home.png)

The main page combines the legal notice banner, country macro KPIs, market board, special date-range controls, and ETF performance blocks in a single Dash interface.

### Agentic AI Research Hub

![Agentic AI sector research overview](https://raw.githubusercontent.com/vulonviing/mini-finance-dashboard/main/screenshots/agentic-ai-sector-research-overview.png)

The Research Hub shows a non-advisory sector-level AI summary, daily research snapshot, and Chronos memory context generated by the multi-agent pipeline.
...
- Python 3.10+
- Dash for the web app shell, callbacks, routing, and interactive controls
- Plotly for charts and financial/macro visualizations
- Pandas for tabular and time-series transformations
- Requests for World Bank, OECD, ECB, and other HTTP fetchers
- yfinance for market prices, ETFs, FX, and index snapshots
- OpenAI API with web search for the real-time news-agent layer
- Optional Ollama support for non-search research, historian, overview, and translation runs
- PyYAML for `ai_config.yaml` loading
- SQLite caching for repeatable refreshes and lower external API load

> Charts in this project are rendered with **Plotly inside Dash**. There is no separate Chart.js layer in the current codebase.
...
> Project context: this repository is maintained as a non-commercial personal project, not as a commercial product or paid data service.
